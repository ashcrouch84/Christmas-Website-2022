...
?>
    ...
    <div class="container py-4">
		<center>
            <h1>Answer Questions about your Family</h1>
            <div class="mb-3">
				<div class="text-center"><?php echo $message; ?> <br />
                Please fill in the questions about the family below
            </div>
		</center>
    </div>
	...
	if ($value == "fi")
							...
							{		
								if ($_FILES["fileToUpload"]["size"] > $limit) 
									{		
										...
										if ($xa == True)
											{
												" Picture has uploaded successfully<BR>";
		...
		<center>					
			<div class="topnav">
				<?php
					$message = "https://4k-photos.co.uk/Personalise22.php?id=".$orderId."&email_entered=".$email."&ref_entered=".$orderId;
					?>
		...
		<?php
								...
								$message = "https://4k-photos.co.uk/Family22.php?id=".$orderId."&email_entered=".$email."&ref_entered=".$orderId;
									...
									<div id="divGroupedProducts">
										<h2>Family Information</h2>
											<form action=<?php echo $message;?> method=post enctype='multipart/form-data'>
												...
												<div class="user-box">
													<select name="before_entered" value="<?php echo $FBefore; ?>">
														<option value="<?php echo $FBefore; ?>"><?php echo $FBefore; ?></option>
												...
												<div class="user-box">
													<select name="keep_entered" value="<?php echo $FKeep; ?>">
														<option value="<?php echo $FKeep; ?>"><?php echo $FKeep; ?></option>
														<option value="Yes">Yes</option>
														<option value="No">No</option>
													</select>
												</div>
												<br>
												<button type="submit" class="btn btn-primary btn-ghost"><?php echo "Update family Information"; ?></button>
				...
				<center>
					<h1>Upload Pictures for your family></h1>
				</center>

				<form action= <?php echo $message?> method=post enctype='multipart/form-data' id="imageform" name="imageform">
					<center>
						<div>
							<h3>Picture of your family on holiday</h3>
						</div>
					</center>
					<?php
						if (file_exists($holidayPic))
						{
							$holidayPic = "https://4k-photos.co.uk/".$holidayPic.'?'.rand(99,9999);
							?>
								<center>
									<p>
										<img src=<?php echo $holidayPic; ?> alt="centered image" width="250" height="250"/>
									</p>
								</center>
								<a>
				...
				<form action= <?php echo $message?> method=post enctype='multipart/form-data' id="imageform" name="imageform">
					<center>
						<div>
							<h3>Picture of your whole family as a group</h3>
						</div>
					</center>
					<?php
						if (file_exists($groupPic))
						{
							$groupPic = "https://4k-photos.co.uk/".$groupPic.'?'.rand(99,9999);
							?>
								<center>
									<p>
										<img src=<?php echo $groupPic; ?> alt="centered image" width="250" height="250"/>
									</p>
								</center>
								<a>
									<center><input accept="image/png, image/gif, image/jpeg"  required type="file" name="fileToUpload" id="fileToUpload" value="Choose file to replace"></center>
