...
<div id="wrapper" class="stickyFooter">
	<header id="header" style="position: relative">
		<div class="container">
			<nav class="navbar navbar-expand-lg">
				...
				<a class="navbar-brand" href="https://4-kingdoms.co.uk/">
                    <img class="logo" src="/assets/images/4-kingdoms-logo1.png" alt="4 kingdoms adventure park" />
                </a>
				<div id="mobileIcons" class="d-flex d-lg-none">
					<ul class="navbar-nav">
						<li class="nav-item dropdown">
							<div class="position-relative d-flex align-items-center">
								<a class="nav-link" href="/my-account"><i class="mdi mdi-account-circle-outline"></i>  <span class="sr-only">My Account</span></a>
								<div class="nav-dropdown-arrow dropdown-toggle"></div>
							</div>
						...
						<li class="nav-item dropdown">
							<a class="nav-link" href="/basket">
                                <i class="mdi mdi-shopping-outline"></i> <span class="sr-only">My Basket</span>
                                <span class="badge header__nav__top--count">0</span>
                            </a>
						</li>
					</ul>
				</div>				
				<div class="navbar-collapse" id="navbarSupportedContent">
					...
					<ul class="navbar-nav ml-auto">
						<li class="nav-item">
							<a class="nav-link" href="https://4-kingdoms.co.uk/">Home</a>
						</li>
                        <li class="nav-item dropdown">
							...
							<div class="dropdown-menu" aria-labelledby="eventsDropdown">
								<a class="dropdown-item" href="https://4-kingdoms.co.uk/special-offers-and-vouchers/">Offers & Vouchers</a>
							</div>
						</li>
                        <li class="nav-item dropdown">
							<a class="nav-link dropdown-toggle" href="#" id="pricesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
							Prices
							</a>
							<div class="dropdown-menu" aria-labelledby="pricesDropdown">
								<a class="dropdown-item" href="https://4-kingdoms.co.uk/opening-times-and-entry-prices/">Times & Prices</a>
                                <a class="dropdown-item" href="https://4-kingdoms.co.uk/birthday-parties/">Birthdays</a>
							</div>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="/https://4-kingdoms.co.uk/farm-news/">Farm News</a>
						</li>
                        <li class="nav-item dropdown">
							...
							<div class="dropdown-menu" aria-labelledby="contactDropdown">
								<a class="dropdown-item" href="https://4-kingdoms.co.uk/terms-and-conditions/">Park T&C's</a>
							</div>
						</li>
					</ul>
	...
	<?php 
		...
		if ($value == "re")
		{
			...
			$response = $client->getBookingsFromEmail($email);
			//echo "<pre>".print_r($response, true)."</pre>";
			if ($response['valid']=="1")
			{
				$Success =true;
				$ref=$response['bookings'][0];
			}
			
			if ($Success == true)
			{
				$to      = $email;
				$subject = 'Your reference number for the Magical Christmas Experience';
				$message = "Thank you for emailing about recovering your booking reference.\n We have successfully found your reference and you should find it below\n ".$ref."\n If you need any more help or are having problems either give us a ring on 01635 269678 or email events@4-kingdoms\n Many thanks and looking forward to seeing you at the Magical Christmas Experience\n 4 Kingdoms Adventure Farm";
				$message = wordwrap($message,100);
				$headers = 'From: events@4-kingdoms.co.uk'       . "\r\n" .
							 'Reply-To: events@4-kingdoms.co.uk' . "\r\n" .
	...
	?>
		 ...
		 <div class="container py-4">
            ...
            <h1>Forgotten Booking Reference</h1>
            <div class="mb-3">
                If you have a booking with us under the email address you just submitted, you will shortly recieve a email with your booking reference<br />
            </div>
			
			<br>
			<div id="divGroupedProducts">
			<form action="https://4k-photos.co.uk/Login22.php"  >
				<button type="submit" class="btn btn-primary btn-ghost">Return to Login Page</button>
			</form>
		</div>
		<br>	
		<br>
	...
	?>
		...
		<h1>Forgotten Booking Reference</h1>
		<div class="mb-3">
			To recover your booking reference please enter your email address below<br />
			<br />
			Alternatively you can phone us on 01635 269678 for help <br />
		</div>
		...
		<div id="divGroupedProducts">
			<form action="https://4k-photos.co.uk/Forgot22.php"  >
				...
				<input type="hidden" name="value_entered" value="re">
				<button type="submit" class="btn btn-primary btn-ghost">Recover</button>
			</form>
		</div>
		...
		<div id="right">
			<div id="divGroupedProducts">
				<form action="https://4k-photos.co.uk/Photos22.php"  >
					<input type="hidden" id="email_entered" name="email_entered" value=<?php echo "$email"; ?>>
					<input type="hidden" id="ref_entered" name="ref_entered" value=<?php echo "$orderId"; ?>>
					<button type="submit" class="btn btn-primary btn-ghost">Return to Photo Download Page</button>
				</form>
			</div>
		</div>
		<br>
